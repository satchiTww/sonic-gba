...
//OBJ SHAPE TETO
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_idleObjShapes.bin", teto_idleObjShapes);
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_walk_0ObjShapes.bin", teto_walk0ObjShapes);
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_walk_1ObjShapes.bin", teto_walk1ObjShapes);
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_walk_2ObjShapes.bin", teto_walk2ObjShapes);
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_walk_3ObjShapes.bin", teto_walk3ObjShapes);
IMPORT_BIN_TO_ROM("data/bin/obj_shapes/teto_walk_4ObjShapes.bin", teto_walk4ObjShapes);
