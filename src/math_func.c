...
u8 angle_table[] = 
{
    ...
    12,12,12,12,13,13,13,13,13,13,13,14,14,14,
...
u8 angle_direction(int xDist, int yDist)
{
    ...
    if (yy >= xx) {
        ...
        angle = 64 - angle_table[compare];
    } else {
        int compare = (yy * 256) / xx;
        angle = angle_table[compare];
    }
